...
module.exports = {
    name: "support", //the command name for the Slash Command
    description: "Rapporter un bug", //the command description for Slash Command Overview
    cooldown: 5,
    ...
    run: async (client, interaction, message) => {
        try {
            ...
            const embed = new MessageEmbed()
                ...
                .setColor(ee.color)
                .setDescription(`Si vous pensez avoir trouvé un bug dans le bot <@!827226279157170236>, rejoignez le serveur de support afin d'expliquer votre problème.\n\nhttps://discord.gg/unwn2Wthty`)
