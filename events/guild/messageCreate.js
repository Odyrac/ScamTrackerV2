    ...
    if (command) {
        ...
        return message.reply({
          embeds: [new Discord.MessageEmbed()
            .setColor(ee.color)
            .setFooter(ee.footertext, ee.footericon)
            .setTitle('ScamTracker v2 est là !')
            .setDescription(`Une nouvelle version de ScamTracker est disponible, utilisant notamment les __**Slash Commands**__ !\n\nDécouvrez la avec \`/help\` !`)]
